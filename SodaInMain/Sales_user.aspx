<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="Sales_user.aspx.cs" Inherits="Sales_user" %>
...
<body>
    ...
    <div style="margin-left: 50px">
        ...
        <asp:GridView ID="GridView1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" Width="400px">
        ...
        <asp:GridView ID="GridView2" AutoGenerateColumns="False" OnRowDataBound="GridView2_RowDataBound" EmptyDataText="No Records" ShowFooter="True"  runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" Width="250px" style="margin-left: 0px" ForeColor="Black" GridLines="None">
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Order" Width="56px" /> <asp:Button ID="Button3" runat="server" Text="Cancel" OnClick="Button3_Click" OnClientClick="cancel()"/>
                </td>
